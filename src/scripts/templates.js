...
export function createLoggedInMenuTemplate() {
    return `
    <a href="#/" class="nav-item">
      <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
...
export function createGuestMenuTemplate() {
    return `
...
export function createStoryListTemplate(story) {
    return `
    <article class="story-card" data-story-id="${story.id}">
      ...
      <div class="story-card-content">
        ...
        <time class="story-date">${story.formattedDate}</time>
        <p class="story-excerpt">${story.description}</p>
      </div>
      <div class="story-card-footer">
        <span class="story-location">${story.lat + story.lon || 'Unknown location'}</span>
